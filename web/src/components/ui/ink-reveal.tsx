"use client";
/*
 * Vendored interactive ink-reveal canvas component (provided verbatim in the
 * integration spec). It uses a self-scheduling requestAnimationFrame loop —
 * the canonical pattern for imperative canvas animation. The experimental
 * React-Compiler lint rules below produce false positives on this pattern;
 * the code type-checks, builds, and runs correctly, so they are scoped-off
 * for this file only.
 */
